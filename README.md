...
[Here](https://plot.ly/~yuchnw/0/#/) is the picture of a sample 3D obstacle map generated using Plotly library. The future step is to parse the Gazebo world into a 3D map.
